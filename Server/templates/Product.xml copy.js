...
<document>
  ...
  <productTemplate theme="light">
    ...
    <banner>
      <heroImg src="${this.BASEURL}images/vCard/address_book2.png" />
      <infoList>
        <info>
          <header>
            <title>Header</title>
    ...
    <shelf>
      ...
      <section>
        <lockup>
         <img src="${this.BASEURL}images/vCard/BortnikSebastian.jpg" width="150" height="150" />

          <title class="showTextOnHighlight"> Titulo </title>
        </lockup>

<lockup>
           <img src="${this.BASEURL}images/vCard/BrumleyTroy.jpg" 
 width="150" height="150" />
          <title class="showTextOnHighlight"> Titulo </title>
        </lockup>

<lockup>
           <img src="${this.BASEURL}images/vCard/CamussiSofia.jpg" />
width="150" height="150" />
          <title class="showTextOnHighlight"> Titulo </title>
        </lockup>
