...
<document>
  ...
  <listTemplate>
    <list>
      <relatedContent>
        <itemBanner>
          <heroImg src="${this.BASEURL}images/Italy/Italy_10_square.jpg" />
        </itemBanner>
      </relatedContent>
      <header>
      ...
      <section>
        ...
        <listItemLockup>
          <img src="${this.BASEURL}images/Iceland/Iceland_1_square_small.jpg" width="90" height="90" />
          <title>Square</title>
        </listItemLockup>
        <listItemLockup>
          <img src="${this.BASEURL}images/Iceland/Iceland_4_poster_small.jpg" width="76" height="135" />
          <title>Poster</title>
        </listItemLockup>
        <listItemLockup>
          <img src="${this.BASEURL}images/Iceland/Iceland_3_poster_small.jpg" width="76" height="135" />
          <title>Title</title>
          <subtitle>Subtitle</subtitle>
        </listItemLockup>
        <listItemLockup style="margin: 0 0 0 -5">
          <img src="${this.BASEURL}images/Iceland/Iceland_4_small.jpg" width="280" height="187" />
          <title>Title</title>
        </listItemLockup>
      </section>
      <section>
        ...
        <listItemLockup class="tallListItemLockup">
          <row class="leftAligned">
            <img src="${this.BASEURL}images/Iceland/Iceland_6_square.jpg" width="90" height="90" />
            <text class="interImageText">vs</text>
            <img src="${this.BASEURL}images/Iceland/Iceland_7_square.jpg" width="90" height="90" />
          </row>
          <title>Title</title>
          <decorationLabel>Right</decorationLabel>
        </listItemLockup>
